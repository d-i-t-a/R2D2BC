...
export async function searchDocDomSeek(searchInput: string, doc: Document, href: string, title: string): Promise<ISearchResult[]> {
    ...
    while (matches = regexp.exec(text)) {
        ...
        const rangeInfo = convertRange(
            range,
            (doc as any).getCssSelector); // computeElementCFI
